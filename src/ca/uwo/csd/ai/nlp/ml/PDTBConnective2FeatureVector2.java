 ...
 */
public class PDTBConnective2FeatureVector2 extends Pipe {
    ...
    String target = null;
    public PDTBConnective2FeatureVector2() {        
        super(new Alphabet(), new LabelAlphabet());
        connAnalyzer = new ConnectiveAnalyzer();
    }
    
    public PDTBConnective2FeatureVector2(String connLexiconPath) {        
        super(new Alphabet(), new LabelAlphabet());
    ...
    public Instance pipe(Instance carrier) {
        ...
        /*if (!sentence.isAnnotatedBy("CHUNK")) {
            sentence = assignFakePOSTags(sentence, root);
            sentence = CHUNKER.annotate(sentence);
        }*/
